...
public class CommandParser {
    ...
    private void parseAttributeDef(TableSchema table) throws Exception {
        ...
        AttributeSchema attr = new AttributeSchema(attrName, dataType, isPK, isNN,isUn,null);
    ...
    private TableSchema parseAlterAdd(TableSchema table) throws Exception {
        ...
        AttributeSchema newAttr = new AttributeSchema(attrName, dataType, false, isNN,isUn,defaultValue);
